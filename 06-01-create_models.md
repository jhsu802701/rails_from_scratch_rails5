...
* In the .rubocop.yml file, add "app/controllers/admins/*.rb" and "app/controllers/users/*.rb" to the list of files excluded from the Style/ClassAndModuleChildren cop.
