...
```
* In the (time)_devise_create_admins.rb file, uncomment the lines under "## Confirmable" and "## Lockable".
...
rails db:migrate:reset
```
* Make the users confirmable and lockable.  Uncomment the lines under "## Confirmable" and "## Lockable" in the  (date)_devise_create_users.rb file.
* Enter the command "rails db:migrate:reset".
